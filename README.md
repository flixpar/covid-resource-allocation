...
We are proposing a system to take advantage of any excess resources or capacity by optimally re-distributing resources and patients between regions. Using data on hospital capacity and resources, as well as forecasts of the number of COVID cases, our model can determine an optimal set of transfers so that the total number of patients who are properly cared for is maximized.

This work is being done by Felix Parker, Darius Irani, Hamilton Sawczuk, and Professor Kimia Ghobadi in the [Center for Systems Science and Engineering](https://systems.jhu.edu/) at Johns Hopkins University.
